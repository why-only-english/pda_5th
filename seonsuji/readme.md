...
X86 기준: Instance의 크기가 커질수록 학습 속도가 빨랐다.
Arm 기준: small, medium, large / xlarge, 2xlarge 두 그룹 간에 유의미한 학습 속도 차이를 보였다. 
두 종류의 아키텍트 중 X86의 학습 속도가 약간 더 빠른 경향을 보였다.

<br>

## 결론
모델 학습을 위해 적합한 아키텍트는 Intel 이다.
원하는 비용과 속도에 맞추어 용량을 선택하는 것을 권장한다.
